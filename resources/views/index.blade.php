		...
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12">
					<div id="gtco-logo"><a href="/">WESTWOOD DINER<em>.</em></a></div>
				</div>
								...
								<div class="tab">
									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											<h3 class="cursive-font">GET STARTED</h3>
											
				
												
												<div class="row form-group">
													<div class="col-md-12">
														<a href="/register" ><input type="button" class="btn btn-success btn-block" value="REGISTER"></a>
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
